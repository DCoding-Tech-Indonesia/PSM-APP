                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 12,
                                                fontWeight: FontWeight.w800,
                                                color: isActive ? const Color(0xFF1565C0) : const Color(0xFF718096),
                                              ),
                                            ),
                                          ],
                                        ),
                                        ...
                                        children: [
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(
                                                    StringFormatter().idrFormatter(detail.billingValue!),
                                                    style: const TextStyle(
                                                      fontSize: 12,
                                          ...
                                          Row(
                                            children: [
                                              GestureDetector(
                                                onTap: () {
                                                  final currentQty = detail.total ?? 0;
                                                  if (currentQty > 0) {
                                                    ...
                                                    context.read<SettlementBloc>().add(
                                                      UpdateDetail(
                                                        ...
                                                        idNasabah: cust.id,
                                                        total: newQty,
                                                        value: newQty * detail.billingValue!,
                                                      ),
                                                    );
                                                  }
                                                },
                                                child: Container(
                                                  ...
                                                  child: const Icon(Icons.remove_rounded, color: Color(0xFF4A5568), size: 16),
                                                ),
                                              ),
                                              SizedBox(
                                                width: 45,
                                                child: TextFormField(
                                                  key: ValueKey('${state.activeTabId}_${cust.id}_${detail.total}'),
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            StringFormatter().idrFormatter(
                                              (detail.total ?? 0) * detail.billingValue!,
                                            ),
                                            style: const TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.w900,
