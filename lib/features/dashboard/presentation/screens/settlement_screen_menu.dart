...
class SettlementScreenMenu extends StatelessWidget {
  const SettlementScreenMenu({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final dates = generateMonthDates(2026, 3);
    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Settlement Report", style: theme.textTheme.titleLarge),
